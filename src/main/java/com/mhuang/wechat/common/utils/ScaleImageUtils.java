...
public class ScaleImageUtils {
    ...
    public static void main(String[] args) throws ImageFormatException, MalformedURLException, IOException {
        System.out.println(ScaleImageUtils.resize(320, 240, null, ImageIO.read(new URL("http://hlld.edu.jsy360.cn/FaceMatch/UpLoads/2016/01/18/2016_01_18_10_02_52_10377_m.jpg"))));
//        System.out.println(ScaleImageUtils.resize(320, 240, ImageQuality.max.getQuality(), null, ImageIO.read(new URL("http://hlld.edu.jsy360.cn/FaceMatch/UpLoads/2016/02/25/2016_02_25_14_24_57_2859_m.jpg"))));
    }
}
